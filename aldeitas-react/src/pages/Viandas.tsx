    ...
    <main className="viandas-page" style={{ paddingTop: '120px' }}>
      ...
      <section id="como-funciona" style={{ padding: '120px 0', background: 'var(--green)', color: 'white' }}>
        <div className="container">
          ...
          >
            {[
              { num: '1', title: 'Definimos la necesidad', text: 'Analizamos la cantidad de personas, dinámicas y preferencias.', icon: <img src={`${import.meta.env.BASE_URL}assets/plato1.png`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Plato 1" /> },
              { num: '2', title: 'Diseñamos la propuesta', text: 'Armamos un servicio a medida para tu empresa.', icon: <img src={`${import.meta.env.BASE_URL}assets/plato2.png`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Plato 2" /> },
              { num: '3', title: 'Elección flexible', text: 'Elección desde nuestra App para cada empleado.', icon: <img src={`${import.meta.env.BASE_URL}assets/plato3.png`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Plato 3" /> },
              { num: '4', title: 'Producción diaria', text: 'Cocinamos todos los días con procesos cuidados.', icon: <img src={`${import.meta.env.BASE_URL}assets/plato4.png`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Plato 4" /> },
              { num: '5', title: 'Entrega puntual', text: 'Llegamos en tiempo y forma, todos los días.', icon: <img src={`${import.meta.env.BASE_URL}assets/plato5.png`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Plato 5" /> }
            ].map((step, idx) => (
              <motion.div
                key={idx}
